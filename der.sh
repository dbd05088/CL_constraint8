...
# CIL CONFIG
NOTE="der_cifar100_memory_free_iter3" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="der"
...
if [ "$DATASET" == "cifar10" ]; then
    ...
    BATCHSIZE=1024; LR=3e-4 OPT_NAME="adam" SCHED_NAME="pred_based" IMP_UPDATE_PERIOD=100
...
do
    CUDA_VISIBLE_DEVICES=7 nohup python main.py --mode $MODE --n_worker 3 \
    --dataset $DATASET \
