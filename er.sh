...
# CIL CONFIG
NOTE="er_cifar100_sample_mem2000" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="er"
...
if [ "$DATASET" == "cifar10" ]; then
    MEM_SIZE=50000 ONLINE_ITER=0.25
    MODEL_NAME="resnet32" EVAL_PERIOD=100
...
do
    CUDA_VISIBLE_DEVICES=4 nohup python main.py --mode $MODE --n_worker 8 \
    --dataset $DATASET \
